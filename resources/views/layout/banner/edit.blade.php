...
@section('content')
    <div class="container-fluid p-2 border border-2 border-white rounded-2 my-5">
        <form class="row g-3" action="{{ route('edit_banner',['id'=>$banner->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
                <label for="inputname4" class="form-label">Name</label>
                <input type="text" class="form-control" id="inputname4" name="name" value="{{ $banner->name }}">
                @if ($errors->has('name'))
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="inputlink4" name="link" value="{{ $banner->link }}">
                @if ($errors->has('link'))
            ...
            <div class="col-md-6">
                <img id="image_preview" style="width: 200px ; height:100px" src="{{ Storage::url($banner->image) }}"
                    alt="User">
            </div>
