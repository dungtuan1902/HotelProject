                                    ...
                                    @foreach ($deleted as $item)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span
                                                    class="badge badge-sm {{ $item->action == 1 ? 'bg-gradient-secondary' : ($item->action == 2 ? 'bg-gradient-success' : 'bg-gradient-warning') }}">{{ $item->action == 1 ? 'Empty' : ($item->action == 2 ? 'Full' : 'Processing') }}</span>
                                            </td>
