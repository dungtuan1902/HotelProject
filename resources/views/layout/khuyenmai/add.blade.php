...
@section('content')
    <div class="container-fluid my-5 p-2 bg-white border border-2 border-white rounded-2">
        <form class="row g-3" action="{{ route('insert_khuyenmai') }}" method="POST">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-6 d-flex align-items-start">
                <div class="col-md-12">
                    ...
                    <input type="range" class="form-range  bg-transpant" name="value" min="0" max="100"
                        step="5" id="myRange">
            ...
            <div class="col-md-6">
                <label for="datetime" class="">Date</label>
                <div class="input-group date" id="datepicker">
                    <input type="date" name="time" class="form-control" id="datetime" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
