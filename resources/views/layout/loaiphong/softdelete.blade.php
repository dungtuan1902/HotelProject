                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ $item->image == '' ? asset('assets/img/team-2.jpg') : Storage::url($item->image) }}"
                                            ...
                                            <td class="align-middle text-sm">
                                                <p class="text-xs text-secondary mb-0">{{ $item->descrition }}</p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="{{ route('restore_delete_typeroom', ['id' => $item->id]) }}"
                                                    class="my-3 btn btn-outline-warning text-warning fw-light text-xs btn-sm"
                                                    data-toggle="tooltip" data-original-title="Edit user">
                                                    Restore
                                                </a>
                                                <a onclick="return confirm('Are you sure ?')"
                                                    href="{{ route('force_delete_typeroom', ['id' => $item->id]) }}"
